const fs = require('fs');
const data = JSON.parse(fs.readFileSync('C:\\Users\\seand\\AppData\\Local\\AgentProfiles\\kilo-a\\cache\\kilo\\models.json', 'utf8'));
...
fs.writeFileSync('S:\\federation\\tmp_nvidia_output.txt', lines.join('\n') + '\n', 'utf8');
