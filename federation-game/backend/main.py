...
from npc_autonomy import (generate_thought, get_recent_thoughts, update_opinion, get_opinion,
    update_mood, get_mood, generate_action, get_recent_actions, get_world_events,
    update_npc_relationship, get_npc_relationships, simulation_tick, get_absence_report, get_relationship_summary, generate_goal, get_goals, advance_goal, set_goal_status, generate_goal_driven_action, make_decision, evaluate_decision_options, get_decision_log, get_world_state, get_world_condition, set_world_condition, get_world_state_history, update_world_state)
...
try:
    from federation_game_rival_simulator import RivalFederation, RivalFederationSimulator
...
from faction_dynamics import get_faction_dynamics, get_faction_detail, get_faction_stances, get_faction_history, get_faction_context_for_npc, KNOWN_FACTIONS, FACTION_DISPLAY
    ...
    def __init__(self):
        ...
        if HISTORY_ARC_AVAILABLE:
            try:
                ...
                if self.tech_tree:
                    self.history_arc.technology = self.tech_tree
                if self.quest_system:
                    self.history_arc.quest_engine = self.quest_system
                if self.npc_system:
                    self.history_arc.npc_engine = self.npc_system
            except Exception as e:
        ...
        self.engine_systems.update({
            "rival_simulator": {"loaded": self.rival_simulator is not None, "active_rivals": len(self.rival_simulator.rivals) if self.rival_simulator and hasattr(self.rival_simulator, 'rivals') else 0},
...
CODEX_EVENT_TEMPLATES = [
    {
        ...
        "faction_affinity": {"research_division": 0.03, "consciousness_collective": 0.03},
        "choices": [
            {
                "id": "document_species",
                ...
                "faction_affinity": {"research_division": 0.08, "preservation_society": 0.03},
            },
            {
                "id": "attempt_taming",
                "text": "ATTEMPT TAMING",
                ...
                "faction_affinity": {"exploration_initiative": 0.05, "military_command": 0.03},
            },
            {
                ...
                "faction_affinity": {"consciousness_collective": 0.08, "cultural_ministry": 0.05},
            },
        ],
    },
    {
    ...
    },
    {
        ...
        "faction_affinity": {"consciousness_collective": 0.02, "research_division": 0.02},
        "choices": [
            {
                "id": "blackbox_record",
                ...
                "faction_affinity": {"preservation_society": 0.08, "research_division": 0.03},
            },
            {
                "id": "anomaly_court",
                "text": "ANOMALY COURT",
                ...
                "faction_affinity": {"diplomatic_corps": 0.08, "cultural_ministry": 0.03},
            },
            {
                "id": "ignore_anomaly",
                "text": "IGNORE IT",
                ...
                "faction_affinity": {"exploration_initiative": 0.03, "preservation_society": -0.05},
            },
        ],
    },
]
...
RIVAL_EVENTS = [
    {
        ...
        "choices": [
            {"id": "counterattack", "text": "COUNTERATTACK", "outcome": "aggressive defense", "reward": {"shields": -15, "hull": -10, "credits": -40, "federation_stability": 5, "crew_morale": 8}, "faction_affinity": {"military_command": 0.10}},
            {"id": "fortify", "text": "FORTIFY BORDERS", "outcome": "defensive posture", "reward": {"credits": -30, "shields": 10, "federation_stability": 3}, "faction_affinity": {"preservation_society": 0.08, "military_command": 0.03}},
            {"id": "negotiate_truce", "text": "NEGOTIATE TRUCE", "outcome": "diplomatic resolution", "reward": {"council_support": 5, "public_trust": 4, "federation_stability": -2}, "faction_affinity": {"diplomatic_corps": 0.10}},
        ],
    },
    {
        "id": "rival_espionage",
        ...
        "choices": [
            {"id": "counter_intel", "text": "COUNTER-INTELLIGENCE SWEEP", "outcome": "security hardened", "reward": {"credits": -25, "council_support": 4, "constitutional_integrity": 3}, "faction_affinity": {"military_command": 0.05}},
            {"id": "public_disclosure", "text": "PUBLIC DISCLOSURE", "outcome": "transparency gambit", "reward": {"public_trust": 8, "federation_stability": -3}, "faction_affinity": {"diplomatic_corps": 0.05, "cultural_ministry": 0.03}},
            {"id": "retaliate_covert", "text": "COVERT RETALIATION", "outcome": "shadow war escalated", "reward": {"constitutional_integrity": -5, "rights_protection": -3, "credits": -20}, "blocked_by_no_gate": True, "no_gate_reward": {"council_support": 2, "constitutional_integrity": 2}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "accept_alliance", "text": "ACCEPT ALLIANCE", "outcome": "new ally gained", "reward": {"allies": 3, "fuel": 20, "council_support": -3, "federation_stability": -2}, "faction_affinity": {"diplomatic_corps": 0.12}},
            {"id": "counter_proposal", "text": "COUNTER-PROPOSAL", "outcome": "negotiated terms", "reward": {"allies": 1, "council_support": 3, "public_trust": 2}, "faction_affinity": {"diplomatic_corps": 0.06, "economic_council": 0.04}},
            {"id": "reject_alliance", "text": "REJECT", "outcome": "independence preserved", "reward": {"federation_stability": 4, "constitutional_integrity": 3}, "faction_affinity": {"preservation_society": 0.08}},
        ],
    },
    {
        "id": "rival_propaganda",
        ...
        "choices": [
            {"id": "truth_campaign", "text": "TRUTH CAMPAIGN", "outcome": "transparency wins", "reward": {"public_trust": 6, "council_support": 2, "credits": -20}, "faction_affinity": {"cultural_ministry": 0.08, "diplomatic_corps": 0.03}},
            {"id": "counter_propaganda", "text": "COUNTER-PROPAGANDA", "outcome": "information war", "reward": {"public_trust": 2, "constitutional_integrity": -4, "rights_protection": -3}, "faction_affinity": {"military_command": 0.05}},
            {"id": "ignore_propaganda", "text": "IGNORE IT", "outcome": "disinformation spreads", "reward": {"public_trust": -5}, "faction_affinity": {"preservation_society": 0.02}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "develop_substitutes", "text": "DEVELOP SUBSTITUTES", "outcome": "self-reliance achieved", "reward": {"credits": -30, "technologies_unlocked": ["resource_synthesis"], "federation_stability": 4}, "faction_affinity": {"research_division": 0.10, "economic_council": 0.05}},
            {"id": "negotiate_trade", "text": "NEGOTIATE TRADE PACT", "outcome": "partial agreement", "reward": {"credits": 20, "fuel": 15, "council_support": -3, "public_trust": 2}, "faction_affinity": {"diplomatic_corps": 0.08}},
            {"id": "retaliate_embargo", "text": "COUNTER-EMBARGO", "outcome": "trade war", "reward": {"credits": -50, "federation_stability": -5, "public_trust": -4, "shields": 5}, "blocked_by_no_gate": True, "no_gate_reward": {"council_support": 3, "federation_stability": 1}},
        ],
    },
    {
        ...
        "faction_affinity": {"military_command": 0.05},
        "choices": [
            {"id": "measured_response", "text": "MEASURED RESPONSE", "outcome": "de-escalation", "reward": {"shields": -5, "council_support": 5, "public_trust": 4}, "faction_affinity": {"diplomatic_corps": 0.08, "preservation_society": 0.03}},
            {"id": "overwhelming_force", "text": "OVERWHELMING FORCE", "outcome": "deterrence through power", "reward": {"shields": -20, "hull": -10, "federation_stability": 5, "public_trust": -6, "emergency_powers": 3}, "faction_affinity": {"military_command": 0.12}},
            {"id": "diplomatic_protest", "text": "DIPLOMATIC PROTEST", "outcome": "formal objection lodged", "reward": {"council_support": 3, "constitutional_integrity": 3, "federation_stability": -2}, "faction_affinity": {"diplomatic_corps": 0.06}},
        ],
    },
]
...
CONSCIOUSNESS_EVENTS = [
    {
        ...
        "choices": [
            {"id": "embrace_dream", "text": "EMBRACE THE VISION", "outcome": "consciousness expanded", "reward": {"crew_morale": 8, "constitutional_integrity": -2, "council_support": 3}, "faction_affinity": {"consciousness_collective": 0.12}},
            {"id": "study_dream", "text": "SCIENTIFIC STUDY", "outcome": "knowledge gained", "reward": {"technologies_unlocked": ["dream_research"], "credits": -15, "crew_morale": 2}, "faction_affinity": {"research_division": 0.08}},
            {"id": "suppress_dream", "text": "SUPPRESS DISTURBANCE", "outcome": "order restored", "reward": {"federation_stability": 3, "crew_morale": -5, "rights_protection": -2}, "faction_affinity": {"military_command": 0.04, "preservation_society": 0.03}},
        ],
    },
    {
        "id": "identity_crisis",
        ...
        "faction_affinity": {"cultural_ministry": 0.04},
        "choices": [
            {"id": "embrace_expansion", "text": "EMBRACE EXPANSION", "outcome": "expansionist path", "reward": {"discovered_sectors": 3, "fuel": -20, "crew_morale": 5, "federation_stability": -3}, "faction_affinity": {"exploration_initiative": 0.10, "economic_council": 0.04}},
            {"id": "consolidate_identity", "text": "CONSOLIDATE IDENTITY", "outcome": "cultural renewal", "reward": {"federation_stability": 5, "public_trust": 4, "constitutional_integrity": 3}, "faction_affinity": {"cultural_ministry": 0.10, "preservation_society": 0.04}},
            {"id": "pluralist_compromise", "text": "PLURALIST COMPROMISE", "outcome": "diverse unity", "reward": {"council_support": 5, "public_trust": 3, "crew_morale": 3}, "faction_affinity": {"diplomatic_corps": 0.08}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "embrace_prophecy", "text": "EMBRACE THE PROPHECY", "outcome": "consciousness deepened", "reward": {"crew_morale": 10, "council_support": -2, "public_trust": 3}, "faction_affinity": {"consciousness_collective": 0.12}},
            {"id": "rational_analysis", "text": "RATIONAL ANALYSIS", "outcome": "pattern recognized", "reward": {"constitutional_integrity": 4, "technologies_unlocked": ["predictive_consciousness"], "crew_morale": -2}, "faction_affinity": {"research_division": 0.10}},
            {"id": "suppress_belief", "text": "SUPPRESS SUPERSTITION", "outcome": "order maintained uneasily", "reward": {"federation_stability": 3, "crew_morale": -8, "rights_protection": -3}, "faction_affinity": {"military_command": 0.04}},
        ],
    },
    {
        ...
        "constitutional_risk": "medium",
        "affected_lane": "Library",
        "faction_affinity": {"consciousness_collective": 0.04, "cultural_ministry": 0.03},
        "choices": [
            {"id": "truth_commission", "text": "TRUTH COMMISSION", "outcome": "painful reckoning", "reward": {"public_trust": 7, "constitutional_integrity": 5, "crew_morale": -6, "federation_stability": -3}, "faction_affinity": {"cultural_ministry": 0.10, "preservation_society": 0.04}},
            {"id": "memorial_ritual", "text": "MEMORIAL RITUAL", "outcome": "collective grieving", "reward": {"crew_morale": 5, "public_trust": 3, "rights_protection": 2}, "faction_affinity": {"consciousness_collective": 0.08, "cultural_ministry": 0.06}},
            {"id": "suppress_memory", "text": "SEAL THE RECORDS", "outcome": "trauma buried again", "reward": {"federation_stability": 5, "constitutional_integrity": -8, "public_trust": -5}, "blocked_by_no_gate": True, "no_gate_reward": {"federation_stability": 2, "council_support": 2}, "faction_affinity": {"preservation_society": -0.05}},
        ],
    },
]
...
QUEST_EVENTS = [
    {
        ...
        "choices": [
            {"id": "study_artifact", "text": "STUDY THE ARTIFACT", "outcome": "research breakthrough", "reward": {"technologies_unlocked": ["ancient_tech"], "crew_morale": 5, "credits": -20}, "faction_affinity": {"research_division": 0.12}},
            {"id": "secure_artifact", "text": "SECURE AND QUARANTINE", "outcome": "cautious containment", "reward": {"shields": 5, "federation_stability": 2, "constitutional_integrity": 2}, "faction_affinity": {"military_command": 0.06, "preservation_society": 0.05}},
            {"id": "return_artifact", "text": "RETURN TO ORIGIN WORLD", "outcome": "diplomatic respect", "reward": {"allies": 2, "public_trust": 5, "council_support": 3}, "faction_affinity": {"diplomatic_corps": 0.10, "cultural_ministry": 0.05}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "welcome_colony", "text": "WELCOME HOME", "outcome": "colony reintegrated", "reward": {"allies": 3, "crew_morale": 10, "credits": -50, "public_trust": 6}, "faction_affinity": {"diplomatic_corps": 0.10, "cultural_ministry": 0.05}},
            {"id": "observe_colony", "text": "OBSERVE FROM AFAR", "outcome": "watchful distance", "reward": {"discovered_sectors": 2, "council_support": 3}, "faction_affinity": {"research_division": 0.06, "preservation_society": 0.04}},
            {"id": "quarantine_colony", "text": "QUARANTINE", "outcome": "cautious isolation", "reward": {"federation_stability": 4, "rights_protection": -4, "public_trust": -3}, "blocked_by_no_gate": True, "no_gate_reward": {"federation_stability": 2, "council_support": 2}},
        ],
    },
    {
        "id": "derelict_ship",
        ...
        "choices": [
            {"id": "board_carefully", "text": "BOARD WITH CAUTION", "outcome": "safe salvage", "reward": {"credits": 80, "technologies_unlocked": ["alien_engineering"], "crew_morale": 3}, "faction_affinity": {"research_division": 0.08, "exploration_initiative": 0.04}},
            {"id": "tow_to_station", "text": "TOW TO STATION", "outcome": "thorough analysis", "reward": {"credits": -20, "technologies_unlocked": ["derelict_analysis"], "council_support": 3, "constitutional_integrity": 2}, "faction_affinity": {"preservation_society": 0.06, "research_division": 0.06}},
            {"id": "destroy_derelict", "text": "DESTROY IT", "outcome": "threat eliminated", "reward": {"federation_stability": 2, "fuel": -10}, "faction_affinity": {"military_command": 0.05}},
        ],
    },
    {
        "id": "ancient_archive",
        ...
        "choices": [
            {"id": "preserve_archive", "text": "PRESERVE AND STUDY", "outcome": "knowledge expanded", "reward": {"technologies_unlocked": ["ancient_governance"], "constitutional_integrity": 4, "public_trust": 5, "credits": -40}, "faction_affinity": {"research_division": 0.10, "cultural_ministry": 0.06}},
            {"id": "restricted_access", "text": "RESTRICT ACCESS", "outcome": "controlled narrative", "reward": {"federation_stability": 4, "council_support": 3, "rights_protection": -4}, "faction_affinity": {"preservation_society": 0.06}},
            {"id": "open_archive", "text": "FULL PUBLIC RELEASE", "outcome": "radical transparency", "reward": {"public_trust": 8, "rights_protection": 5, "federation_stability": -6, "council_support": -4}, "blocked_by_no_gate": True, "no_gate_reward": {"public_trust": 4, "rights_protection": 3}},
        ],
    },
]
...
NPC_EVENTS = [
    {
        ...
        "choices": [
            {"id": "defend_ambassador", "text": "DEFEND AMBASSADOR", "outcome": "loyalty affirmed", "reward": {"council_support": 6, "public_trust": 4, "federation_stability": -2}, "faction_affinity": {"diplomatic_corps": 0.12}},
            {"id": "investigate_ambassador", "text": "FULL INVESTIGATION", "outcome": "truth sought", "reward": {"constitutional_integrity": 5, "rights_protection": 4, "council_support": -2}, "faction_affinity": {"preservation_society": 0.08}},
            {"id": "sacrifice_ambassador", "text": "SACRIFICE FOR STABILITY", "outcome": "political pawn", "reward": {"federation_stability": 5, "public_trust": -6, "crew_morale": -8}, "blocked_by_no_gate": True, "no_gate_reward": {"council_support": 3, "federation_stability": 1}},
        ],
    },
    {
        "id": "crew_mutiny",
        ...
        "choices": [
            {"id": "address_grievances", "text": "ADDRESS GRIEVANCES", "outcome": "labor peace", "reward": {"crew_morale": 12, "council_support": 4, "credits": -30}, "faction_affinity": {"cultural_ministry": 0.10, "preservation_society": 0.03}},
            {"id": "discipline_crew", "text": "ENFORCE DISCIPLINE", "outcome": "order through force", "reward": {"crew_morale": -10, "federation_stability": 3, "rights_protection": -5}, "blocked_by_no_gate": True, "no_gate_reward": {"federation_stability": 1, "crew_morale": -3}},
            {"id": "mediate_dispute", "text": "MEDIATE DISPUTE", "outcome": "compromise reached", "reward": {"crew_morale": 5, "public_trust": 3, "council_support": 2}, "faction_affinity": {"diplomatic_corps": 0.06}},
        ],
    },
    {
        "id": "whistleblower",
        ...
        "faction_affinity": {"cultural_ministry": 0.04},
        "choices": [
            {"id": "protect_whistleblower", "text": "PROTECT WHISTLEBLOWER", "outcome": "accountability upheld", "reward": {"public_trust": 8, "constitutional_integrity": 5, "council_support": -4, "federation_stability": -3}, "faction_affinity": {"cultural_ministry": 0.10, "preservation_society": 0.04}},
            {"id": "investigate_claims", "text": "INVESTIGATE CLAIMS", "outcome": "measured response", "reward": {"council_support": 3, "constitutional_integrity": 3, "public_trust": 2}, "faction_affinity": {"diplomatic_corps": 0.05}},
            {"id": "prosecute_leak", "text": "PROSECUTE THE LEAK", "outcome": "silence enforced", "reward": {"council_support": 4, "federation_stability": 3, "rights_protection": -8, "public_trust": -7}, "blocked_by_no_gate": True, "no_gate_reward": {"federation_stability": 1, "council_support": 2}},
        ],
    },
    {
        "id": "hero_fall",
        ...
        "choices": [
            {"id": "full_trial", "text": "FULL TRIAL", "outcome": "justice served publicly", "reward": {"rights_protection": 8, "constitutional_integrity": 5, "crew_morale": -5, "military support": -3}, "faction_affinity": {"preservation_society": 0.08, "cultural_ministry": 0.06}},
            {"id": "quiet_retirement", "text": "QUIET RETIREMENT", "outcome": "face-saving exit", "reward": {"crew_morale": 2, "federation_stability": 3, "rights_protection": -3, "public_trust": -2}, "faction_affinity": {"military_command": 0.06, "diplomatic_corps": 0.03}},
            {"id": "pardon_hero", "text": "PARDON FOR SERVICE", "outcome": "precedent of impunity", "reward": {"crew_morale": 5, "rights_protection": -10, "constitutional_integrity": -8, "public_trust": -5}, "blocked_by_no_gate": True, "no_gate_reward": {"council_support": 2, "constitutional_integrity": 2}},
        ],
    },
]
...
ERA_EVENTS = [
    {
        ...
        "choices": [
            {"id": "open_contact", "text": "OPEN CONTACT", "outcome": "diplomatic first contact", "reward": {"allies": 4, "crew_morale": 10, "technologies_unlocked": ["alien_diplomacy"], "federation_stability": -3}, "faction_affinity": {"diplomatic_corps": 0.12, "exploration_initiative": 0.08}},
            {"id": "observe_contact", "text": "OBSERVE SILENTLY", "outcome": "watchful first contact", "reward": {"discovered_sectors": 4, "technologies_unlocked": ["stealth_observation"]}, "faction_affinity": {"research_division": 0.10}},
            {"id": "avoid_contact", "text": "AVOID AND DOCUMENT", "outcome": "missed connection", "reward": {"federation_stability": 3, "rights_protection": 2}, "faction_affinity": {"preservation_society": 0.08}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "grand_celebration", "text": "GRAND CELEBRATION", "outcome": "morale surge", "reward": {"crew_morale": 15, "public_trust": 6, "credits": -60}, "faction_affinity": {"cultural_ministry": 0.12}},
            {"id": "reflection_summit", "text": "REFLECTION SUMMIT", "outcome": "institutional growth", "reward": {"constitutional_integrity": 5, "council_support": 5, "public_trust": 3}, "faction_affinity": {"preservation_society": 0.08, "diplomatic_corps": 0.04}},
            {"id": "work_through_it", "text": "WORK THROUGH IT", "outcome": "stoic perseverance", "reward": {"credits": 30, "crew_morale": -3}, "faction_affinity": {"economic_council": 0.05}},
        ],
    },
    {
        ...
        "choices": [
            {"id": "limited_reform", "text": "LIMITED REFORM", "outcome": "incremental improvement", "reward": {"constitutional_integrity": 6, "rights_protection": 3, "council_support": 4, "public_trust": 3}, "faction_affinity": {"preservation_society": 0.10, "diplomatic_corps": 0.04}},
            {"id": "bold_rewrite", "text": "BOLD REWRITE", "outcome": "revolutionary change", "reward": {"constitutional_integrity": -5, "rights_protection": 8, "public_trust": -4, "federation_stability": -6, "council_support": -3}, "faction_affinity": {"consciousness_collective": 0.10, "cultural_ministry": 0.06}},
            {"id": "reject_convention", "text": "REJECT CONVENTION", "outcome": "status quo defended", "reward": {"federation_stability": 5, "constitutional_integrity": -3, "public_trust": -5}, "faction_affinity": {"military_command": 0.04}},
        ],
    },
    {
        "id": "galactic_crisis",
        ...
        "choices": [
            {"id": "lead_coalition", "text": "LEAD THE COALITION", "outcome": "Federation ascendant", "reward": {"allies": 5, "council_support": 8, "federation_stability": -4, "credits": -80, "fuel": -30}, "faction_affinity": {"diplomatic_corps": 0.12, "military_command": 0.06}},
            {"id": "contribute_quietly", "text": "CONTRIBUTE QUIETLY", "outcome": "reliable partner", "reward": {"allies": 2, "federation_stability": 3, "public_trust": 4, "credits": -30}, "faction_affinity": {"preservation_society": 0.06, "diplomatic_corps": 0.05}},
            {"id": "isolate_survive", "text": "ISOLATE AND SURVIVE", "outcome": "go it alone", "reward": {"federation_stability": -8, "public_trust": -6, "constitutional_integrity": 3, "shields": 10}, "blocked_by_no_gate": True, "no_gate_reward": {"federation_stability": -3, "constitutional_integrity": 2, "council_support": 1}},
        ],
    },
]

ALL_DYNAMIC_EVENTS = RIVAL_EVENTS + CONSCIOUSNESS_EVENTS + QUEST_EVENTS + NPC_EVENTS + ERA_EVENTS
        ...
        "choices": [
            {
                ...
                "faction_affinity": {"diplomatic_corps": 0.10, "consciousness_collective": 0.03},
            },
            {
                "id": "scan",
                "text": "SCAN SHIP",
            ...
            },
            {
                ...
                "outcome": "defensive",
                "reward": {"shields": 10},
                "faction_affinity": {"military_command": 0.10, "preservation_society": 0.03},
            },
        ],
    },
    {
        ...
        "choices": [
            {
                ...
                "faction_affinity": {"exploration_initiative": 0.10, "research_division": 0.03},
            },
            {
                "id": "scan",
                "text": "SCAN IT",
            ...
            {"id": "avoid", "text": "GO AROUND", "outcome": "safe", "reward": {}, "faction_affinity": {"preservation_society": 0.05}},
        ],
    },
        {
            "id": "distress",
        ...
        },
        {
            ...
            "choices": [
                ...
                },
                {
                    ...
                    "outcome": "safe",
                    "reward": {"shields": -5},
                    "faction_affinity": {"military_command": 0.03, "preservation_society": 0.03},
                },
            ],
        },
        {
        ...
        },
        {
            ...
            "image": "anomaly",
            "faction_affinity": {"research_division": 0.03, "consciousness_collective": 0.02},
            "choices": [
                {
                    "id": "investigate",
                    "text": "INVESTIGATE",
                    ...
                    "faction_affinity": {"research_division": 0.10, "consciousness_collective": 0.05},
                },
                {"id": "retreat", "text": "RETREAT", "outcome": "safe", "reward": {}, "faction_affinity": {"preservation_society": 0.05}},
            ],
        },
        {
            ...
            "choices": [
                {
                    ...
                    "faction_affinity": {"research_division": 0.05, "preservation_society": 0.05},
                },
                {
                    ...
                    "faction_affinity": {"consciousness_collective": 0.08, "research_division": -0.03},
                },
                {
                    ...
                    "lesson": "Recovery is checkpoint discipline.",
                    "faction_affinity": {"preservation_society": 0.08, "diplomatic_corps": 0.03},
                },
            ],
        },
        {
...
async def get_engine_status():
    ...
    return {
        ...
        "quest_system": {
            ...
            "completed_quests": sum(len(v) for v in game_state.quest_system.completed_quests.values()),
        ...
        "npc_system": {
            ...
            "recruited": sum(1 for c in game_state.npc_system.companions.values() if c.is_recruited),
        ...
        "turn_progression": {
            ...
            "divergences_triggered": sum(1 for d in tl.divergence_points if d.triggered),
        ...
        "rival_simulator": {
            "active_rivals": len(game_state.rival_simulator.rivals) if game_state.rival_simulator and hasattr(game_state.rival_simulator, 'rivals') else 0,
            "status": "system_available" if game_state.rival_simulator else "not_loaded",
        },
        "consciousness_sheet": {
            "morale": game_state.consciousness_sheet.morale if game_state.consciousness_sheet else 0,
            "identity": game_state.consciousness_sheet.identity if game_state.consciousness_sheet else 0,
            "anxiety": game_state.consciousness_sheet.anxiety if game_state.consciousness_sheet else 0,
            "status": "system_available" if game_state.consciousness_sheet else "not_loaded",
        },
        "history_arc": {
            "current_era": str(getattr(game_state.history_arc, 'current_era', 'unknown')) if game_state.history_arc else "not_loaded",
            "year": getattr(game_state.history_arc, 'current_year', 0) if game_state.history_arc and hasattr(game_state.history_arc, 'current_year') else 0,
            "status": "system_available" if game_state.history_arc else "not_loaded",
        },
        "political_engine": {
            "status": "system_available" if game_state.political_engine else "not_loaded",
        },
    }
...
async def get_random_event():
    ...
    if (game_state.public_trust < 45 or game_state.council_support < 45 or game_state.federation_stability < 45 or game_state.constitutional_integrity < 50 or game_state.rights_protection < 50 or game_state.emergency_powers > 60 or turn % 4 == 0):
    ...
    if game_state.rival_simulator:
        try:
            hostile_count = sum(1 for r in game_state.rival_simulator.rivals.values() if r.relationships.get("player", "neutral") == "hostile")
    ...
    recent_ids = [r.get("event_id", "") for r in game_state.engine_systems["event_registry"]["events_seen"][-10:]]
    ...
    if category == "governance":
        ...
        non_repeat = [e for e in RIVAL_EVENTS if e["id"] not in recent_ids] or RIVAL_EVENTS
        event = random.choice(non_repeat)
    elif category == "consciousness":
        non_repeat = [e for e in CONSCIOUSNESS_EVENTS if e["id"] not in recent_ids] or CONSCIOUSNESS_EVENTS
        event = random.choice(non_repeat)
    elif category == "quest":
        non_repeat = [e for e in QUEST_EVENTS if e["id"] not in recent_ids] or QUEST_EVENTS
        event = random.choice(non_repeat)
    elif category == "npc":
        non_repeat = [e for e in NPC_EVENTS if e["id"] not in recent_ids] or NPC_EVENTS
        event = random.choice(non_repeat)
    elif category == "era":
        non_repeat = [e for e in available_era if e["id"] not in recent_ids] or available_era
        event = random.choice(non_repeat)
    else:
...
async def make_choice(choice_id: str):
    ...
    if game_state.turn >= VICTORY_TURN and game_over is None:
        if (game_state.federation_stability > 30 and game_state.public_trust > 20 and game_state.constitutional_integrity > 20 and game_state.rights_protection > 20):
    ...
    game_state.engine_systems["turn_progression"]["current_phase"] = game_state.timeline.current_era.value
    ...
    game_state.timeline.update_consciousness(
        ...
        breakthrough=any(k in deltas and deltas[k] > 10 for k in ["constitutional_integrity", "rights_protection"]),
    )
    ...
    if game_state.rival_simulator:
        try:
            ...
            results = game_state.rival_simulator.act_all_rivals(game_state.timeline.current_year, context)
            game_state.engine_systems["rival_simulator"]["active_rivals"] = len(game_state.rival_simulator.rivals) if hasattr(game_state.rival_simulator, 'rivals') else 0
    ...
    if game_state.consciousness_sheet:
        try:
            ...
            elif choice_id in ("counterattack", "blast", "discipline_crew", "retaliate_covert"):
            ...
            if hasattr(cs, 'prophecies') and cs.anxiety > 0.7 and game_state.turn % 5 == 0:
                prophecy_narratives = [
            ...
            game_state.engine_systems["consciousness_sheet"]["stability"] = 1.0 - cs.anxiety
        except Exception:
            pass
    ...
    if game_state.political_engine:
        try:
            ...
            fed_state = game_state.game_state_v2.federation if game_state.game_state_v2 else None
            if fed_state:
                prev_law_count = len(game_state.political_engine.laws_passed) if hasattr(game_state.political_engine, 'laws_passed') else 0
                game_state.political_engine.process_year(current_year, fed_state)
                new_law_count = len(game_state.political_engine.laws_passed) if hasattr(game_state.political_engine, 'laws_passed') else 0
                game_state.engine_systems["political_engine"]["laws_passed"] = new_law_count
                if new_law_count > prev_law_count and hasattr(game_state.political_engine, 'laws_passed'):
                    for law in game_state.political_engine.laws_passed:
                        if isinstance(law, dict):
                            law_name = law.get("name", law.get("title", "unknown"))
                            if any(kw in str(law_name).lower() for kw in ["rights", "freedom", "protection", "privacy"]):
                                game_state.constitutional_integrity = min(100, game_state.constitutional_integrity + 2)
                                game_state.rights_protection = min(100, game_state.rights_protection + 1)
                                political_effects[law_name] = "rights_boost"
                            elif any(kw in str(law_name).lower() for kw in ["security", "defense", "military", "emergency"]):
                                game_state.federation_stability = min(100, game_state.federation_stability + 2)
                                game_state.emergency_powers = min(100, game_state.emergency_powers + 1)
                                political_effects[law_name] = "security_boost"
                            elif any(kw in str(law_name).lower() for kw in ["trade", "economic", "resource", "budget"]):
                                game_state.credits += 20
                                game_state.public_trust = max(0, game_state.public_trust - 1)
                                political_effects[law_name] = "economic_boost"
                            elif any(kw in str(law_name).lower() for kw in ["diplomacy", "treaty", "alliance", "cooperation"]):
                                game_state.council_support = min(100, game_state.council_support + 2)
                                political_effects[law_name] = "diplomatic_boost"
                            else:
                                game_state.federation_stability = min(100, game_state.federation_stability + 1)
    ...
    if game_state.history_arc:
        try:
            ...
            history_arc_result = {
                ...
                "year": getattr(game_state.history_arc, 'current_year', 0) if hasattr(game_state.history_arc, 'current_year') else 0,
            }
            if ha_result and isinstance(ha_result, dict):
                ...
                if era_changed:
                    ...
                    game_state.federation_stability = min(100, game_state.federation_stability + 3)
    ...
    game_state.timeline.record_narrative(
        ...
        tags=[event.get("domain", "Operations"), choice.get("affected_lane", "Control Plane")],
    )

    # Faction drift on decade gates
    if timeline_result.get("decade_gate"):
        faction_allies = {fid: list(f.ally_factions) for fid, f in game_state.faction_system.factions.items()}
        faction_enemies = {fid: list(f.enemy_factions) for fid, f in game_state.faction_system.factions.items()}
        current_reps = {
            fid: game_state.faction_system.get_player_reputation("player", fid)
            for fid in game_state.faction_system.factions
        }
        drifted = game_state.timeline.apply_faction_drift(current_reps, faction_allies, faction_enemies)
        for fid, new_rep in drifted.items():
            game_state.faction_system.change_reputation("player", fid, new_rep - current_reps.get(fid, 0.5))
        game_state.engine_systems["faction_system"]["player_standing"] = {
            fid: game_state.faction_system.get_player_reputation("player", fid)
            for fid in game_state.faction_system.factions
        }
    ...
    rep_values = list(game_state.engine_systems["faction_system"]["player_standing"].values())
    if rep_values:
        max_rep = max(rep_values)
        min_rep = min(rep_values)
        divergence_metrics["faction_polarization"] = max_rep - min_rep if max_rep != min_rep else 0.0
    else:
    ...
    return {
        ...
        "timeline": {
            ...
            "divergences_triggered": [{"id": d.divergence_id, "description": d.description} for d in triggered_divergences],
        },
...
async def join_faction(faction_id: str):
    ...
    if not success:
        raise HTTPException(status_code=400, detail=f"Already a member of '{faction_id}'")
    game_state.engine_systems["faction_system"]["player_standing"] = {
        fid: fs.get_player_reputation("player", fid)
        for fid in fs.factions
    }
    return {
        "joined": faction_id,
...
async def spawn_random_encounter():
    ...
    if encounter.get("type") == "character":
        return {
            ...
            "character": game_state.npc_system.get_character_report(entity.char_id) if entity else None,
        }
    else:
        return {
            "type": "creature",
            "description": encounter.get("description", ""),
            "creature": game_state.npc_system.get_creature_report(entity.creature_id) if entity else None,
        }
...
async def interact_with_npc(char_id: str, req: InteractRequest):
    ...
    if not result.get("success"):
        raise HTTPException(status_code=400, detail=result.get("message", "Interaction failed"))
    return result
...
async def encounter_creature(creature_id: str, req: EncounterRequest):
    ...
    if not result.get("success", True) and result.get("message") == "Creature not found":
        raise HTTPException(status_code=404, detail="Creature not found")
...
async def npc_chat_endpoint(char_id: str, req: NPCChatRequest):
    ...
    result = chat_with_npc(character, req.message, model=req.model, player_id=req.player_id)
    return result
...
async def npc_opinion_update(char_id: str, player_id: str = "player_1", interaction: str = "neutral"):
    if char_id not in game_state.npc_system.characters:
        raise HTTPException(status_code=404, detail="Character not found")
    ...
    for npc in npc_list:
        ...
        try:
            ...
            if not existing:
                ...
                goals_generated += 1
            goal_action = generate_goal_driven_action(cid, npc["name"], npc["archetype"], npc.get("affiliation", ""))
            if goal_action:
                goal_actions += 1
        except Exception:
            pass
...
async def get_rivals():
    ...
    try:
        ...
        return {"rivals": states, "system_available": True, "total": len(game_state.rival_simulator.rivals) if hasattr(game_state.rival_simulator, 'rivals') else 0}
    except Exception as e:
...
async def spawn_rival():
    ...
    try:
        ...
        game_state.engine_systems["rival_simulator"]["active_rivals"] = len(game_state.rival_simulator.rivals) if hasattr(game_state.rival_simulator, 'rivals') else 0
        return {"result": "spawned", "total_rivals": game_state.engine_systems["rival_simulator"]["active_rivals"]}
    except Exception as e:
...
async def get_history_arc():
    ...
    try:
        ...
        return {
            ...
            "year": getattr(ha, 'current_year', 0) if hasattr(ha, 'current_year') else getattr(ha.timeline, 'current_year', 0),
...
async def get_systems_overview():
    ...
    overview = {
        "core_systems": {
            "factions": game_state.engine_systems.get("faction_system", {}).get("loaded", False),
            "timeline": game_state.engine_systems.get("turn_progression", {}).get("loaded", False),
            "npcs": game_state.engine_systems.get("npc_system", {}).get("loaded", False),
            "quests": game_state.engine_systems.get("quest_system", {}).get("loaded", False),
            "technology": game_state.engine_systems.get("technology_tree", {}).get("loaded", False),
            "events": game_state.engine_systems.get("event_registry", {}).get("loaded", False),
        },
        "new_systems": {
    ...
    overview["integration_status"]["loaded_systems"] = sum(1 for v in all_systems.values() if v)
    return overview
...
async def npc_evaluate_decisions(char_id: str):
    ...
    affiliation = character.affiliation
    mood = get_mood(char_id)
    options = evaluate_decision_options(char_id, character.name, archetype, affiliation, mood=mood)
    return {"char_id": char_id, "name": character.name, "mood": mood, "options": options}
...
async def set_world_condition_endpoint(condition: str, value: int = None):
    ...
    return {"condition": condition, "value": clamped, "previous_range": f"{config['min']}-{config['max']}"}
